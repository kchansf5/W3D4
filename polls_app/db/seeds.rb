...
User.destroy_all
  ...
  Question.destroy_all
    ...
    answer21 = AnswerChoice.create!(answer: "Maybe", question_id: question2.id)
  ...
  Response.create!(user_key: hagrid.id, question_key: question2.id, answer_key: answer3.id)
  Response.create!(user_key: hagrid.id, question_key: question3.id, answer_key: answer5.id)
  Response.create!(user_key: hagrid.id, question_key: question4.id, answer_key: answer7.id)
  Response.create!(user_key: hagrid.id, question_key: question5.id, answer_key: answer9.id)
  Response.create!(user_key: hagrid.id, question_key: question6.id, answer_key: answer12.id)
  Response.create!(user_key: hagrid.id, question_key: question7.id, answer_key: answer13.id)
  Response.create!(user_key: hagrid.id, question_key: question8.id, answer_key: answer16.id)
  Response.create!(user_key: hagrid.id, question_key: question9.id, answer_key: answer18.id)

  # Harry only likes Dumbledore's
  Response.create!(user_key: harry.id, question_key: question6.id, answer_key: answer12.id)
  Response.create!(user_key: harry.id, question_key: question7.id, answer_key: answer14.id)
  Response.create!(user_key: harry.id, question_key: question8.id, answer_key: answer15.id)
  Response.create!(user_key: harry.id, question_key: question9.id, answer_key: answer17.id)

  # Hermione only likes her own
  Response.create!(user_key: hermione.id, question_key: question3.id, answer_key: answer5.id)
  Response.create!(user_key: hermione.id, question_key: question4.id, answer_key: answer8.id)
  Response.create!(user_key: hermione.id, question_key: question5.id, answer_key: answer10.id)

  # Dumbledore is also nice and likes everyone's questions (even his own)
  Response.create!(user_key: dumbledore.id, question_key: question1.id, answer_key: answer1.id)
  Response.create!(user_key: dumbledore.id, question_key: question2.id, answer_key: answer21.id)
  Response.create!(user_key: dumbledore.id, question_key: question3.id, answer_key: answer6.id)
  Response.create!(user_key: dumbledore.id, question_key: question4.id, answer_key: answer7.id)
  Response.create!(user_key: dumbledore.id, question_key: question5.id, answer_key: answer10.id)
  Response.create!(user_key: dumbledore.id, question_key: question6.id, answer_key: answer11.id)
  Response.create!(user_key: dumbledore.id, question_key: question7.id, answer_key: answer14.id)
  Response.create!(user_key: dumbledore.id, question_key: question8.id, answer_key: answer16.id)
  Response.create!(user_key: dumbledore.id, question_key: question9.id, answer_key: answer18.id)
end
